...
from test_framework.revoconfig import COINBASE_MATURITY
from test_framework.revo import convert_btc_address_to_revo
...
class ScantxoutsetTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(convert_btc_address_to_revo("mkHV1C6JLheLoUSSZYk7x3FH5tnx9bu7yc"), 0.008) # (m/0'/0'/0')
        self.nodes[0].sendtoaddress(convert_btc_address_to_revo("mipUSRmJAj2KrjSvsPQtnP8ynUon7FhpCR"), 0.016) # (m/0'/0'/1')
        self.nodes[0].sendtoaddress(convert_btc_address_to_revo("n37dAGe6Mq1HGM9t4b6rFEEsDGq7Fcgfqg"), 0.032) # (m/0'/0'/1500')
        self.nodes[0].sendtoaddress(convert_btc_address_to_revo("mqS9Rpg8nNLAzxFExsgFLCnzHBsoQ3PRM6"), 0.064) # (m/0'/0'/0)
        self.nodes[0].sendtoaddress(convert_btc_address_to_revo("mnTg5gVWr3rbhHaKjJv7EEEc76ZqHgSj4S"), 0.128) # (m/0'/0'/1)
        self.nodes[0].sendtoaddress(convert_btc_address_to_revo("mketCd6B9U9Uee1iCsppDJJBHfvi6U6ukC"), 0.256) # (m/0'/0'/1500)
        self.nodes[0].sendtoaddress(convert_btc_address_to_revo("mj8zFzrbBcdaWXowCQ1oPZ4qioBVzLzAp7"), 0.512) # (m/1/1/0')
        self.nodes[0].sendtoaddress(convert_btc_address_to_revo("mfnKpKQEftniaoE1iXuMMePQU3PUpcNisA"), 1.024) # (m/1/1/1')
        self.nodes[0].sendtoaddress(convert_btc_address_to_revo("mou6cB1kaP1nNJM1sryW6YRwnd4shTbXYQ"), 2.048) # (m/1/1/1500')
        self.nodes[0].sendtoaddress(convert_btc_address_to_revo("mtfUoUax9L4tzXARpw1oTGxWyoogp52KhJ"), 4.096) # (m/1/1/0)
        self.nodes[0].sendtoaddress(convert_btc_address_to_revo("mxp7w7j8S1Aq6L8StS2PqVvtt4HGxXEvdy"), 8.192) # (m/1/1/1)
        self.nodes[0].sendtoaddress(convert_btc_address_to_revo("mpQ8rokAhp1TAtJQR6F6TaUmjAWkAWYYBq"), 16.384) # (m/1/1/1500)
        ...
        assert_equal(descriptors(self.nodes[0].scantxoutset("start", [ {"desc": "combo(tprv8ZgxMBicQKsPd7Uf69XL1XwhmjHopUGep8GuEiJDZmbQz6o58LninorQAfcKZWARbtRtfnLcJ5MQ2AtHcQJCCRUcMRvmDUjyEmNUWwx8UbK/0h/0'/*)", "range": 1499}])), ["pkh([0c5f9a1e/0'/0'/0]026dbd8b2315f296d36e6b6920b1579ca75569464875c7ebe869b536a7d9503c8c)#dzxw429x", "pkh([0c5f9a1e/0'/0'/1]033e6f25d76c00bedb3a8993c7d5739ee806397f0529b1b31dda31ef890f19a60c)#43erceed"])
