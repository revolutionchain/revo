...
"""
class RevoPOSConflictingStakingMempoolTxTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Allow the revo staker some time to run (since we set a mocktime the time will not advance)
        time.sleep(80)
...
if __name__ == '__main__':
    RevoPOSConflictingStakingMempoolTxTest().main()