...
from test_framework.revo import generatesynchronized, convert_btc_bech32_address_to_revo
...
class WalletHDTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        non_hd_add = convert_btc_bech32_address_to_revo('bcrt1qmevj8zfx0wdvp05cqwkmr6mxkfx60yezwjksmt')
