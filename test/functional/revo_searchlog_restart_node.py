...
from test_framework.revoconfig import ENABLE_REDUCED_BLOCK_TIME

import sys


RPC_INVALID_PARAMETER = -8
class RevoRPCSearchlogsTestModified(BitcoinTestFramework):
...
if __name__ == '__main__':
    RevoRPCSearchlogsTestModified().main()