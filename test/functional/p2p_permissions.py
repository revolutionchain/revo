...
from test_framework.revo import convert_btc_bech32_address_to_revo
...
class P2PPermissionsTests(BitcoinTestFramework):
    ...
    def check_tx_relay(self):
        block_op_true = self.nodes[0].getblock(self.nodes[0].generatetoaddress(COINBASE_MATURITY+1, convert_btc_bech32_address_to_revo(ADDRESS_BCRT1_P2WSH_OP_TRUE))[0])
        self.sync_all()
