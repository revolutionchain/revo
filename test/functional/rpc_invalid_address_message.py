...
BECH32_VALID = convert_btc_bech32_address_to_revo('bcrt1qtmp74ayg7p24uslctssvjm06q5phz4yrxucgnv')
BECH32_INVALID_BECH32 = convert_btc_bech32_address_to_revo('bcrt1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqdmchcc')
BECH32_INVALID_BECH32M = convert_btc_bech32_address_to_revo('bcrt1qw508d6qejxtdg4y5r3zarvary0c5xw7k35mrzd', encoding=Encoding.BECH32M)
BECH32_INVALID_VERSION = convert_btc_bech32_address_to_revo('bcrt130xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqynjegk')
BECH32_INVALID_SIZE = convert_btc_bech32_address_to_revo('bcrt1s0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7v8n0nx0muaewav25430mtr')
BECH32_INVALID_V0_SIZE = convert_btc_bech32_address_to_revo('bcrt1qw508d6qejxtdg4y5r3zarvary0c5xw7kqqq5k3my')
BECH32_INVALID_PREFIX = 'qc1q79ley3n84mj5pz8n879fzdqfz92qayjp74hrx6'

BASE58_VALID = convert_btc_address_to_revo('mipcBbFg9gMiCh81Kj8tqqdgoZub1ZJRfn')
