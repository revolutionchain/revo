...
BASE_SCRIPTS = [
    ...
    # 'wallet_orphanedreward.py', // N/A in Revo due to rolling checkpoints 
    ...
    'revo_header_spam.py --dos-same-height',
    'revo_header_spam.py --dos-variable-height',
    'revo_header_spam.py --run-standard-tests',
...
def check_script_prefixes():
    ...
    good_prefixes_re = re.compile("^(example|feature|interface|mempool|mining|p2p|rpc|wallet|tool|revo)_")
