...
////////////////////////////////////////////////////////////// // revo
    void setRevoSchedule(EVMSchedule _revoSchedule) const { revoSchedule = _revoSchedule; }

    EVMSchedule& getRevoSchedule() const { return revoSchedule; }
...
private:
    ...
    mutable EVMSchedule revoSchedule; // revo
