...
#include "genesis/revoNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::revoNetwork: return c_genesisInfoRevoNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::revoNetwork: return c_genesisStateRootRevoNetwork;
    default:
        throw std::invalid_argument("Invalid network value");
    }
}
...
std::string dev::eth::genesisInfoRevo(Network _n, EVMConsensus _consensus)
{
