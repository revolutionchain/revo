...
/// Set the improvements activation blocks for Revo
struct EVMConsensus
{
    EVMConsensus() {}
...
/**
 * @brief genesisInfoRevo Get the genesis information for EVM
 * @param _n Network type
 * @param _consensus Revo network consensus parameters (mainnet, testnet, signet or regtest parameters)
 * @return Genesis information for EVM
 */
std::string genesisInfoRevo(Network _n, EVMConsensus _consensus);
