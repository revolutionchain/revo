...
//    initState();
    ...
    std::vector<RevoTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createRevoTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createRevoTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createRevoTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createRevoTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
