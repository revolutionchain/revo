...
void DeleteBlockChainData()
{
    ...
    fs::remove_all(GetDataDir() / "stateRevo");
    ...
    while (!fLoaded && !ShutdownRequested()) {
        ...
        do {
            ...
            try {
                ...
                fs::path revoStateDir = GetDataDir() / "stateRevo";
            ...
            try {
                ...
                globalSealEngine->setRevoSchedule(revoDGP.getGasSchedule(::ChainActive().Height() + (::ChainActive().Height()+1 >= chainparams.GetConsensus().QIP7Height ? 0 : 1) ));
