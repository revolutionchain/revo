...
public:
    CMainParams() {
        ...
        // consensus.defaultAssumeValid = uint256S("0x0000bc5ae2d1f69111ec64d6dd74243253e73aede12d4311c2e3554cfc811836"); // genesis
        consensus.defaultAssumeValid = uint256S("0x0000b211c3305246935f0911f698227249e7094bf06154da8fe200bb37745983"); // last PoW block == 2500
	...
	vSeeds.emplace_back("seed5.revo.network"); // Revo mainnet
        ...
        chainTxData = ChainTxData{
            // Data as of block 0000b211c3305246935f0911f698227249e7094bf06154da8fe200bb37745983 (height 2500)
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        */
        ...
        checkpointData = {
            {
                {0, uint256S("0xd95c32ffcbc10e35f35203c0a12ed2389e4fd967de04209f548ce86685f81a46")},
            }
        };
