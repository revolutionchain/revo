...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " revo-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  revo-tx [options] <hex-tx> [commands]  Update hex-encoded revo transaction\n" +
            "or:     revo-tx [options] -create [commands]   Create hex-encoded revo transaction\n" +
            "\n";
