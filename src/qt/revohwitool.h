#ifndef REVOHWITOOL_H
#define REVOHWITOOL_H
...
/**
 * @brief The RevoHwiTool class Communicate with the Revo Hardware Wallet Interface Tool
 */
class RevoHwiTool : public QObject
{
    Q_OBJECT
public:
    /**
     * @brief RevoHwiTool Constructor
     * @param parent Parent object
     */
    explicit RevoHwiTool(QObject *parent = nullptr);

    /**
     * @brief ~RevoHwiTool Destructor
     */
    ~RevoHwiTool();
