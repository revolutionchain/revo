...
*/
class RevoGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit RevoGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~RevoGUI();
...
private:
    ...
    RevoVersionChecker *revoVersionChecker = nullptr;
