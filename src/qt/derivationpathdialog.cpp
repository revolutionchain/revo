    ...
    ui(new Ui::DerivationPathDialog)
{
    ...
    ui->txtLegacy->setText(RevoHwiTool::derivationPathPKH());
    ui->txtLegacy->setPlaceholderText(RevoHwiTool::derivationPathPKH());
    ...
    ui->txtP2SH->setText(RevoHwiTool::derivationPathP2SH());
    ui->txtP2SH->setPlaceholderText(RevoHwiTool::derivationPathP2SH());
    ...
    ui->txtSegWit->setText(RevoHwiTool::derivationPathBech32());
    ui->txtSegWit->setPlaceholderText(RevoHwiTool::derivationPathBech32());
