    ...
    walletFrame(qobject_cast<WalletFrame*>(parent))
{
    ...
    QPushButton *exportButton = new RevoPushButton(tr("&Export"), this);
    ...
    // Pass through messages from ERCTokenPage
    connect(ERCTokenPage, &ERCToken::message, this, &WalletView::message);
