...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("RVO");
    case mBTC: return QString("mRVO");
    case uBTC: return QString::fromUtf8("μRVO (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Revos");
    case mBTC: return QString("Milli-Revos (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Revos (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
