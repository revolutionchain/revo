...
{
    // Call into TxToUniv() in revo-common to decode the transaction hex.
    //
    // Blockchain contextual information (confirmations and blocktime) is not
    // available to code in revo-common, so we query them here and push the
                            ...
                            {"contract", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "(send to contract)",
                                {
                                    ...
                                    {"amount", RPCArg::Type::AMOUNT,  RPCArg::Default{0}, "Value in RVO to send with the call, should be a valid amount, default 0"},
                                    ...
                                    {"senderAddress", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "The revo address that will be used to create the contract."},
                                },
                                },
...
static RPCHelpMan decodepsbt()
{
    return RPCHelpMan{"decodepsbt",
                "\nReturn a JSON object representing the serialized, base64-encoded partially signed Revo transaction.\n",
                {
                            ...
                            {RPCResult::Type::OBJ, "", "",
                            {
                                ...
                                {RPCResult::Type::OBJ, "witness_utxo", /* optional */ true, "Transaction output for witness UTXOs",
                                {
                                    ...
                                    {RPCResult::Type::OBJ, "scriptPubKey", "",
                                    {
                                        ...
                                        {RPCResult::Type::STR_HEX, "hex", "The hex"},
                                        {RPCResult::Type::STR, "type", "The type, eg 'pubkeyhash'"},
                                        {RPCResult::Type::STR, "address"," Revo address if there is one"},
                                    }},
                                }},
...
static RPCHelpMan combinepsbt()
{
    return RPCHelpMan{"combinepsbt",
                "\nCombine multiple partially signed Revo transactions into one transaction.\n"
