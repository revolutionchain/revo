...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "erc20listtransactions", 2, "fromblock"},
    { "erc20listtransactions", 3, "minconf"},
    //////////////////////////////////////////////////
    ...
    { "erc20approve", 4, "gaslimit" },
    { "erc20approve", 5, "gasprice" },
    { "erc20approve", 6, "checkoutputs" },
    { "erc20transfer", 4, "gaslimit" },
    { "erc20transfer", 5, "gasprice" },
    { "erc20transfer", 6, "checkoutputs" },
    { "erc20transferfrom", 5, "gaslimit" },
    { "erc20transferfrom", 6, "gasprice" },
    { "erc20transferfrom", 7, "checkoutputs" },
    { "erc20burn", 3, "gaslimit" },
    { "erc20burn", 4, "gasprice" },
    { "erc20burn", 5, "checkoutputs" },
    { "erc20burnfrom", 4, "gaslimit" },
    { "erc20burnfrom", 5, "gasprice" },
    { "erc20burnfrom", 6, "checkoutputs" },
