...
/**
 * @brief The IRevoStaker class Delegation filter
 */
...
/**
 * @brief The RevoDelegation class Communicate with the revo delegation contract
 */
class RevoDelegation {
    
public:
    /**
     * @brief RevoDelegation Constructor
     */
    RevoDelegation();

    /**
     * @brief ~RevoDelegation Destructor
     */
    virtual ~RevoDelegation();
...
private:
    RevoDelegation(const RevoDelegation&);
    RevoDelegation& operator=(const RevoDelegation&);
    RevoDelegationPriv* priv;
};
#endif
