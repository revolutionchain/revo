...
public:
    ...
    void setRevoTokenExec(RevoTokenExec* tokenExec);
    ...
    // Static functions
    static bool ToHash160(const std::string& strRevoAddress, std::string& strHash160);
    static bool ToRevoAddress(const std::string& strHash160, std::string& strRevoAddress);
...
private:
    ...
    RevoToken(RevoToken const&);
    RevoToken& operator=(RevoToken const&);
