...
/**
 * @brief The RevoLedger class Communicate with the revo ledger
 */
class RevoLedger {
    
public:
    /**
     * @brief RevoLedger Constructor
     */
    RevoLedger();

    /**
     * @brief ~RevoLedger Destructor
     */
    virtual ~RevoLedger();
...
private:
    RevoLedger(const RevoLedger&);
    RevoLedger& operator=(const RevoLedger&);
    RevoLedgerPriv* d;
};
#endif
